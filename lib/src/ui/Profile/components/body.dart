...
class Body extends StatelessWidget {
  ...
  double calculateDistance(
      List<double> currentPosition, List<double> userPosition) {
    //Position currentPosition =  getCurrentPosition();
    return Geolocator.distanceBetween(currentPosition[0], currentPosition[1],
  ...
  Widget build(BuildContext context) {
    ...
    int distance = 0;
    String km =
        ctrx!.read<UserpreferenceBloc>().state.userPreference!.showDistancesIn!;
    if (myLocation != null) {
                    ...
                    child: Stack(
                      children: [
                        ...
                        Align(
                            ...
                            child: LineIndicator(
                                user: user, pageController: pageController)),
                      ],
                    ),
                  ),
                ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          Container(
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: 24,
                                fontFamily: 'Proxima-Nova_Extrabold',
                      ...
                      (user.verified != null &&
                              user.verified != VerifiedStatus.pending.name &&
                              user.verified != VerifiedStatus.notVerified.name)
                          ? SizedBox(
                              child: Row(
                                children: [
                                  //Icon(Icons.verified,color: Colors.blue, size:18,),
                                  TagHelper.getTag(
                                      name: user.verified!, size: 16),
                                  SizedBox(
                                    width: 7,
                                  ),
                                  Text(user.verified!,
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(lookignForOptions[user.lookingFor ?? 0]
                                        .replaceAll('\n', ''))
                      ...
                      InkWell(
                        ...
                        onTap: () {
                          ...
                          if (profileFrom == ProfileFrom.like) {
                            //
                            context.read<LikeBloc>().add(DeleteLikedMeUser(
                                userId:
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            ...
                            if (profileFrom == ProfileFrom.like) {
                              if (context.read<PaymentBloc>().state.superLikes >
                                  0) {
                                context.read<LikeBloc>().add(LikeLikedMeUser(
                                    user: (context.read<ProfileBloc>().state
                                            as ProfileLoaded)
                                        .user,
                                ...
                                showPaymentDialog(
                                    context: context,
                                    paymentUi: PaymentUi.superlikes);
                              }
                            }
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      child: Row(children: [
                        ...
                        SizedBox(width: 10),
                        Text('Nudity or something sexually explicit',
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => Report(
                                      ...
                                      index: 10,
                                      name:
                                          'Something that happened off HabeshaWe or in person',
                                      ctx: context,
                                    )));
                      },
                      child: Row(children: [
                        ...
                        Text(
                            'Something that happened off HabeshaWe\nor in person',
                            style: TextStyle(fontSize: 13.sp))
                      ]),
                    ),
                  ),
