                ...
                Padding(
                  ...
                  child: Align(
                    ...
                    child: Row(children: [
                      ...
                      (match!.verified != VerifiedStatus.notVerified.name &&
                              match!.verified != VerifiedStatus.pending.name &&
                              match!.verified != null)
                          ? TagHelper.getTag(
                              name: match!.verified ?? 'not', size: 16)
                          : const SizedBox(),
                    ]),
                  ),
                ),
